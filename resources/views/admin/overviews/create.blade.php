...
@section('title', 'Thêm mới Nội dung Tổng quan')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Thêm mới Nội dung Tổng quan</h3>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.overviews.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('paragraph_1') is-invalid @enderror" 
                                              ...
                                              placeholder="Nhập nội dung đoạn văn thứ nhất">{{ old('paragraph_1') }}</textarea>
                                    @error('paragraph_1')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('paragraph_2') is-invalid @enderror" 
                                              ...
                                              placeholder="Nhập nội dung đoạn văn thứ hai">{{ old('paragraph_2') }}</textarea>
                                    @error('paragraph_2')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('video_title') is-invalid @enderror" 
                                           id="video_title" name="video_title" value="{{ old('video_title') }}" 
