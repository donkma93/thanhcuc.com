        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Chỉnh sửa Gallery: {{ $gallery->title }}</h3>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('type') is-invalid @enderror" id="type" name="type" required>
                                        ...
                                        <option value="classroom" {{ old('type', $gallery->type) === 'classroom' ? 'selected' : '' }}>Lớp học</option>
                                        <option value="facility" {{ old('type', $gallery->type) === 'facility' ? 'selected' : '' }}>Cơ sở vật chất</option>
                                    </select>
                                    @error('type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group" id="level-group" style="display: none;">
                                    ...
                                    <select class="form-control @error('level') is-invalid @enderror" id="level" name="level">
                                        ...
                                        <option value="A1" {{ old('level', $gallery->level) === 'A1' ? 'selected' : '' }}>A1</option>
                                        <option value="A2" {{ old('level', $gallery->level) === 'A2' ? 'selected' : '' }}>A2</option>
                                        <option value="B1" {{ old('level', $gallery->level) === 'B1' ? 'selected' : '' }}>B1</option>
                                        <option value="B2" {{ old('level', $gallery->level) === 'B2' ? 'selected' : '' }}>B2</option>
                                        <option value="C1" {{ old('level', $gallery->level) === 'C1' ? 'selected' : '' }}>C1</option>
                                        <option value="C2" {{ old('level', $gallery->level) === 'C2' ? 'selected' : '' }}>C2</option>
                                        <option value="All" {{ old('level', $gallery->level) === 'All' ? 'selected' : '' }}>Tất cả cấp độ</option>
                                    </select>
                                    @error('level')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group" id="students-group" style="display: none;">
                                    ...
                                    <input type="text" class="form-control @error('students') is-invalid @enderror" 
                                           id="students" name="students" value="{{ old('students', $gallery->students) }}" 
                                ...
                                <div class="card bg-light">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text small">
                                            <strong>Tạo:</strong> {{ $gallery->created_at->format('d/m/Y H:i') }}<br>
                                            <strong>Cập nhật:</strong> {{ $gallery->updated_at->format('d/m/Y H:i') }}<br>
