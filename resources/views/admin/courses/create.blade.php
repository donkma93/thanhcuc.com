...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="h3 mb-0 text-gray-800">Thêm khóa học mới</h1>
        <p class="text-muted">Tạo khóa học mới cho hệ thống</p>
    </div>
    <div>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('target_score') is-invalid @enderror" 
                               id="target_score" name="target_score" value="{{ old('target_score') }}" 
                        ...
                        <div class="feature-item mb-3">
                            <div class="input-group">
                                <input type="text" class="form-control" name="features[]" 
                                       placeholder="VD: Học 1-1 với giáo viên bản ngữ" value="{{ old('features.0') }}">
...
<script>
    ...
    document.getElementById('name').addEventListener('input', function() {
        // This could be used to show slug preview if needed
    });
</script>
@endpush