...
@section('header')
    <div>
        ...
        <p class="text-muted mb-0">Tạo lý do mới để khách hàng chọn Thanh Cúc</p>
    </div>
    <div>
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div id="reasonPreview" class="card h-100" style="border-left: 4px solid #F9D200;">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                <div class="reason-icon" style="color: #F9D200;" id="previewIconContainer">
                                    <i class="fas fa-star fa-2x"></i>
                                </div>
                            </div>
                            
                            <h6 class="card-title" id="previewTitle">Tiêu đề lý do</h6>
                            <p class="card-text text-muted small" id="previewDescription">
                                Mô tả lý do sẽ hiển thị ở đây...
                            </p>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updatePreview() {
            const title = titleInput.value || 'Tiêu đề lý do';
            const description = descriptionInput.value || 'Mô tả lý do sẽ hiển thị ở đây...';
            const icon = iconInput.value || 'fas fa-star';
            const color = colorInput.value || '#F9D200';
            ...
            // Update status badge
            const statusBadge = previewCard.querySelector('.badge');
            statusBadge.className = `badge ${isActive ? 'bg-success' : 'bg-secondary'}`;
            statusBadge.textContent = isActive ? 'Hiển thị' : 'Ẩn';
            
            // Update sort order
            const sortBadge = previewCard.querySelector('.badge.bg-light');
            sortBadge.textContent = `#${sortOrder}`;
        }
